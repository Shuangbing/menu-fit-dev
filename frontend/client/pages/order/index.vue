<template>
  <div>
    <md-notice-bar v-show="!data.table_smoking" icon="warn" mode="closable" type="warning">禁煙席のため喫煙をご遠慮ください</md-notice-bar>
    ...
    <div style="height: 60vh; bottom: 0;">
      <md-scroll-view
        :scrolling-x="false"
        :auto-reflow="true"
...
export default class Order extends Vue {
  ...
  async asyncData({ app, query }) {
    ...
    let data = await app.$axios.$get("/client/order/" + localStorage.tableId);
