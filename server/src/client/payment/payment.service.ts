...
export class PaymentService {
    ...
    async LINE_PAY_CONFIRM(amount: number, transactionId: string) {
        ...
        return await axios.default.post('https://sandbox-api-pay.line.me/v2/payments/' + transactionId + '/confirm', data, { headers: headers })
            .then(res => {
                if (res.data.returnCode === '0000') {
                    return {
            ...
            .catch(error => { throw new HttpException('支払いの確認ができませんでした', 403); });
    }
}
